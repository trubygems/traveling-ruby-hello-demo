...
tools=(
  lib${PATH_SEPERATOR}ruby${PATH_SEPERATOR}bin${PATH_SEPERATOR}ruby
  hello
)
...
for tool in ${tools[@]}; do
  ...
  if [ "$tool" = lib${PATH_SEPERATOR}ruby${PATH_SEPERATOR}bin${PATH_SEPERATOR}ruby ]; then  test_cmd="--version" ; fi
